...
const StorageMetrics: React.FC<any> = ({ accountStats }) => {
  ...
  return (
    <div className="metric-grid">
      <div className="metric-card" style={{ padding: '32px', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', position: 'relative', zIndex: 2 }}>
          <div>
            <div style={{ fontSize: '10px', fontWeight: 800, opacity: 0.7, letterSpacing: '2px', marginBottom: '8px' }}>NODE VOLUME</div>
      ...
      <div className="glass-card" style={{ padding: '24px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <div style={{ height: '4px', background: 'var(--accent)', borderRadius: '10px', marginTop: '12px', overflow: 'hidden' }}>
